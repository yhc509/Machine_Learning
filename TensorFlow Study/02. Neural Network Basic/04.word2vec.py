...
# 단어 벡터를 분석해볼 임의의 문장들
sentences = ["I love a Cat",
             "I love a Puppy",
             "I love a Animal",
             "Puppy Cat Animal",
             "Girlfriend Cat Puppy love",
             "Cat Fish Milk Love",
             "Puppy Fish hate Milk love",
             "Puppy Cat Eye love",
             "I Girlfriend love",
             "Girlfriend I hate",
             "Girlfriend I Movie Book Music love",
             "I Game Cartoon Animation love",
             "Cat Puppy hate",
             "Puppy Cat love"]
...
loss = tf.reduce_mean(
            tf.nn.nce_loss(
                weights=nce_weights,        # Tensor of shape()
                biases=nce_biases,          # vector of zeros; len()
                labels=labels,              # labels == context words enums
                inputs=selected_embed,      # Tensor of shape(,)
                num_sampled=num_sampled,    # 64: randomly chosen negative (rare) words
                num_classes=voc_size        #  : by construction
                ))
