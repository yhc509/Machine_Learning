...
W_encode = tf.Variable(tf.random_normal([n_input, n_hidden]),name='W_encode')
...
W_decode = tf.Variable(tf.random_normal([n_hidden, n_input]),name='W_decode')
b_decode = tf.Variable(tf.random_normal([n_input]),name='b_decode')
